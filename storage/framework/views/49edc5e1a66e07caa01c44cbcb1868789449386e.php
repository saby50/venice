                    ...
                    <div class="col-md-12">
                      ...
                      <table class="table borderless">
                        ...
                        <?php foreach($cart as $key => $value): ?>
                          ...
                          ?>
                          <tr>
                          <td><table><tr><td><a href="<?= URL::to('food_cart/remove_item/'.$key) ?>"><img src="<?php echo e(asset('public/images/cross.jpg')); ?>" class="remove" data="<?= $key ?>"></a></td>
