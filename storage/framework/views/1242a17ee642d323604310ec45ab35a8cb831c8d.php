...
<div class="panel-content">
  <form action="<?php echo e(URL::to('admin/units/update')); ?>" method="post">
...
<script type="text/javascript">
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/units/delete_foodstore_app/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
