...
<form action="<?php echo e(URL::to('send/feedback')); ?>" method="post">
<?php echo csrf_field(); ?>
<?php 
    $userid = "0";
    $i = 0;
...
<?php else: ?>
  <img src="<?php echo e(asset('public/images/yeah.png')); ?>"><br /><br />Thanks for your rating
<?php endif; ?>
</div>
...
<?php echo $__env->make('layouts.feedback', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\nxampp\htdocs\venice\resources\views/feedback/index.blade.php ENDPATH**/ ?>