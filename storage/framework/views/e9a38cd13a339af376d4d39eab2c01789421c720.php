...
<div class="row">
	...
	<div class="col-12">
		...
		<div class="wallet-box ripple">
			...
			<div class="row">
				<div class="col-5">
					<img src="<?php echo e(asset('public/images/pwa/walleticon.PNG')); ?>" class="walleticon" alt="walleticon.PNG" ><br />
					...
					<div class="col-7">
						<img src="<?php echo e(asset('public/images/pwa/earn.PNG')); ?>" alt="earn.PNG"><br />
						<div style="margin-top: 3px;">Get UPTO <span style="color: #6be61a;font-size: 20px;">10%</span> EXTRA ON GV PAY</div>
						<a href="<?php echo e(URL::to($wallet)); ?>"><img src="<?php echo e(asset('public/images/pwa/recharge.PNG')); ?>" style="margin-bottom: -22px;" alt="recharge.PNG" class="wallrech"></a>
