...
<head>
    ...
    <!-- Meta-Information -->
    <title> <?php echo e(ucfirst(config('multiauth.prefix'))); ?>  <?php echo $__env->yieldContent('title'); ?> </title>
    <meta charset="utf-8">
...
<?php echo $__env->make('vendor.multiauth.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php if($type=="web" || $type=="all"): ?>
 <?php echo $__env->make('multiauth::admin.notifications', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>  
<style type="text/css">
  .ripple {
    position: relative;
...
</html><?php /**PATH C:\xampp\nxampp\htdocs\venice\resources\views/vendor/multiauth/layouts/main.blade.php ENDPATH**/ ?>