...
<?php if(Helper::check_mobile()==1): ?>
      <div class="slider-pwa">
        <img data-u="image" src="<?php echo e(asset('public/images/pages/bakeriesm.jpg')); ?>"  class="mobile" />
      </div>
  <?php else: ?>
  <!--==========================
    Hero Section
  ============================-->
    <section id="" class="homehero" style="z-index: 1;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:550px;overflow:hidden;">
            <div>
                <img data-u="image" src="<?php echo e(asset('public/images/pages/bakeries.jpg')); ?>" class="desktop" />
                <img data-u="image" src="<?php echo e(asset('public/images/pages/bakeriesm.jpg')); ?>" class="mobile" />
            </div>
...
<?php endif; ?>
    ...
    <div id="packages" class="wow fadeInDown" style="display: none;">
        <div class="row" style="width: 100%; text-align: center; margin-left: 0; margin-right: 0; padding-top: 0.5rem; padding-bottom: 0.5rem;">
            ...
            <div class="col-4">
                <div class="pack pk3">
                    <a href="<?= URL::to('bakery#bmenu') ?>"><img src="<?php echo e(asset('public/images/bakerya.jpg')); ?>"></a>
                    ...
                    <div class="col-md-5 col-12">
                      <?php if(Helper::check_mobile()==1): ?>
                        ...
                        <iframe width="100%" height="250" class="youtube-video" src="https://www.youtube.com/embed/PddSUho7PeI?start=2" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                         <?php else: ?>
                           <img src="<?php echo e(asset('public/images/pages/bakeryvid.png')); ?>">
 ...
 <section id="logoarea">
            <div class="container">
                <div class="row" style="height: 250px;">
                    ...
                    <div class="col-md-3 col-12 logosmargin">
                        <img src="<?php echo e(asset('public/images/gallery/bakery/bakery1.jpg')); ?>" style="width: 220px;">                       
                    </div>
                     <div class="col-md-3 col-12 logosmargin">
                        <img src="<?php echo e(asset('public/images/gallery/bakery/bakery2.jpg')); ?>" style="width: 220px;">                      
                    </div>
                    <div class="col-md-3 col-12 logosmargin" >
                        <img src="<?php echo e(asset('public/images/gallery/bakery/bakery3.jpg')); ?>" style="width: 220px;">                      
                    </div>
                     <div class="col-md-3 col-12 logosmargin">
                        <img src="<?php echo e(asset('public/images/gallery/bakery/bakery4.jpg')); ?>" style="width: 220px;">                      
                    </div>
  ...
  <ul class="mobile-slider2">
                <li>
                   <img src="<?php echo e(asset('public/images/gallery/bakery/gallery3.jpg')); ?>">
                 </li>
                    <li>
                   <img src="<?php echo e(asset('public/images/gallery/bakery/gallery2.jpg')); ?>">
                 </li> 
                  <li>
                   <img src="<?php echo e(asset('public/images/gallery/bakery/gallery1.jpg')); ?>">
                 </li> 
