...
<div class="panel-content">
  <form action="<?php echo e(URL::to('admin/venue/add')); ?>" method="post">
		...
		<div class="col-md-12">
          ...
          <?php if(session('status')): ?>
             ...
             <div class="col-md-6">
                ...
                <input type="text" class="form-control "   placeholder="Enter your address" name="location"  required>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <label>Authorised Person</label>
                    <input type="text" class="form-control" name="authorised_person"  required>
                  </div>
                  <div class="col-md-6">
                    <label>Email</label>
             ...
             onFocus="geolocate()" name="address"  id="street_number"  required>
                          </div>
                             <div class="col-md-6">                     
                        <label>Days</label><br />
...
<?php /* C:\xampp\nxampp\htdocs\venice\resources\views/vendor/multiauth/admin/venue/create.blade.php */ ?>