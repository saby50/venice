		...
		<div class="col-md-8 column">
			<div class="top-bar-chart">
				<div class="quick-report">
					...
					<span class="bar2"><a href="<?php echo e(URL::to('admin/manage_users/create')); ?>"><button class="btn btn-primary">Create</button></a></span>
				</div>
