...
<div class="panel-content">
	...
	<div class="row" style="margin-top: -40px;">
		...
		<form action="<?php echo e(URL::to('admin/booking/cash')); ?>" method="post" id="myform">
			<?php echo csrf_field(); ?>
   ...
   <div style="position: relative;float: right;display: none;"><a href="#" class="requestfullscreen" style="color: #000;" title="Fullscreen"><i class="fa fa-arrows-alt fa-2x" aria-hidden="true"></i></a>
            ...
            <div class="col-md-6 col-md-offset-3">
              ...
              <input type="hidden" name="transvalue" class="transvalue" value="offline">
						...
						<input type="text" name="phone" class="form-control phone" required="required" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="10" maxlength="10">
...
<script type="text/javascript" src="<?php echo e(asset('js/jquery.fullscreen-0.4.1.min.js')); ?>"></script>
<style type="text/css">
    #loader {
    display: none;
    position: absolute;
    top: 0; left: 0; right: 0; bottom: 0;
    background: rgba(255,255,255,0.8) url(<?php echo e(asset('images/loader2.gif')); ?>) center center no-repeat;
    z-index: 1000;
}
.fade-scale {
  transform: scale(0);
