        ...
        <div class="row">
            <div class="col-sm-12" style="z-index: 999;margin-left: -30px;">
                <ul>
                    ...
                    <?php if(Helper::get_device_platform()=="android"): ?>   
                    <li class="list-inline-item" style="width: 100%;text-align: center;"><span style="color: #EF9E11">Download App: </span> <a href="https://play.google.com/store/apps/details?id=com.thebhasin.thegrandvenice" target="_blank"><img src="<?php echo e(asset('public/images/google.png')); ?>" style="height: 40px;width: auto;"></a></li>
                    <?php else: ?>
                    <li class="list-inline-item" style="width: 100%;text-align: center;"><span style="color: #EF9E11">Download App: </span> <a href="https://apps.apple.com/gb/app/the-grand-venice-mall/id1492430011?ign-mpt=uo%3D2" target="_blank"><img src="<?php echo e(asset('public/images/apple.png')); ?>" style="height: 40px;width: auto;"></a></li>
                     <?php endif; ?>
...
<div class="headpwa" style="z-index: 1000;">
  <?php else: ?>
	...
	<img src="<?php echo e(asset('public/images/logowhite.png')); ?>" width="80px;" style="margin-top: -5px;margin-left: 20px;">
   <?php elseif(Request::segment(1)=="booking" || Request::segment(1)=="packs" ): ?>
    <span class="backbtn ripple" style="font-size: 16px;">
      <?php if(Helper::get_device_platform()=="android"): ?>   
      <img src="<?php echo e(asset('public/images/pwa/back_arrow.png')); ?>" width="20">
       <?php else: ?>
 ...
 <span class="backbtn ripple" style="font-size: 18px;"> <?php if(Helper::get_device_platform()=="android"): ?>   
  ...
  <?php elseif(Request::is('food_cart')): ?>
    <span class="backbtn ripple" style="font-size: 18px;"> <?php if(Helper::get_device_platform()=="android"): ?>   
      <a href="<?= URL::to($url) ?>"><img src="<?php echo e(asset('public/images/pwa/back_arrow.png')); ?>" width="20"></a>
       <?php else: ?>
        <i class="fa fa-chevron-left fa-lg" aria-hidden="true" style="color: white"></i>
      <?php endif; ?>&nbsp;&nbsp;&nbsp;&nbsp;Your Cart</span>
	...
	<?php else: ?>
      ...
      <img src="<?php echo e(asset('public/images/pwa/back_arrow.png')); ?>" width="20">
       <?php else: ?>
        <i class="fa fa-chevron-left fa-lg" aria-hidden="true" style="color: white"></i>
      <?php endif; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $__env->yieldContent('title'); ?></span>
	<?php endif; ?>
	</div>
	<div class="col-3 rightside">
    <?php if(Request::is('wallet')): ?>
		<div style="text-align: right;margin-left: -20px;"><a href="<?php echo e(URL::to('wallet/recharge')); ?>" style="color: #FFF;font-size: 14px;"><img src="<?php echo e(asset('public/images/topup.PNG')); ?>" width="40px"></a></div>
     <?php elseif(Request::is('wallet/recharge')): ?>
      ...
      <?php elseif(Request::is('profile')): ?>
        <div style="text-align: right;"><a href="<?php echo e(URL::to('logout')); ?>" style="color: #FFF;font-size: 14px;" onclick="event.preventDefault();
 ...
 <?php elseif(Request::is('pay')): ?>
    ...
    <?php else: ?>
       <?php if(Request::is('history/all')): ?>
        <!--  <div style="text-align: right;"><a href="<?php echo e(URL::to('profile')); ?>" style="color: #FFF;font-size: 14px;">Edit Profile</a></div> -->
      ...
      <ul class="notifications">
        ...
        ?>
      <li class="noti"><a href="<?php echo e(URL::to('notifications')); ?>" class="ripple"><i class="fa fa-bell" aria-hidden="true"></i> 
        <?php if($count != 0): ?>
  ...
  <div class="row" style="position: relative;top: -40px;">
     ...
     <ul class="sidemenu-pwa">
  	...
  	<div class="col-12" style="text-align: center;">
  		<a href="<?php echo e(URL::to('contact')); ?>"><button class="btn btn-orange">Contact us</button></a>
...
<?php /**PATH C:\xampp\nxampp\htdocs\venice\resources\views/layouts/headerpwa.blade.php ENDPATH**/ ?>