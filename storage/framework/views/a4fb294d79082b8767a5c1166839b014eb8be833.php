    ...
    <div id="invoice" class="container">
        <div class="row mb-5">
            <table style="width: 100%">
                ...
                <img src="<?php echo e(asset('images/logo.png')); ?>" style="width: 200px;">
        ...
        <div class="row">
            <div class="col-md-12">
                <ul>
                  ...
                  <li>For query, write to info@veniceindia.com</li>
                </ul>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\nxampp\htdocs\venice\resources\views/ordermail.blade.php ENDPATH**/ ?>