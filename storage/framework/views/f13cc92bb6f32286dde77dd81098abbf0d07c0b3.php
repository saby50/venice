		...
		<div class="col-md-8 column">
			<div class="top-bar-chart">
				<div class="quick-report">
					...
					<span class="bar2"><a href="<?php echo e(URL::to('admin/users/export')); ?>"><button class="btn btn-primary">Export</button></a></span>
				</div>
...
<div class="panel-content">
	...
	<div class="row">
		<form action="<?php echo e(URL::to('admin/users/sendsms')); ?>" method="post">
			<?php echo csrf_field(); ?>
