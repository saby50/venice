...
?>
    ...
    <div class="booking-form" style="display: block;">
        ...
        <form action="<?php echo e(URL::to('send/leads')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <?php else: ?>
            ...
            <div class="container wow fadeIn">
                ...
                <?php if ($pack_type == "leads"): ?>
                         ...
                         <div class="col-md-4" style="margin-top: 40px;">
                            ...
                            <li><img src="<?php echo e(asset('public/images/metroconnect.png')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Near Pari Chowk<br /> Metro Station</p></li>
                            </div>
                             <div class="col-md-4" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/corporatehub.png')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Amidst<br /> Corporate Hub</p></li>
                            </div>
                             <div class="col-md-4" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/leaseoptions.png')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Attractive<br /> Leasing Options</p></li>
                            </div>
                        <div class="col-md-4" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/powerbackup.png')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">100%<br /> Power Back-up</p></li>
                           
                          
                        </li></div>
                         <div class="col-md-4" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/airconditioned.png')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Centrally<br /> Airconditioned</p></li>
                           </div>
                        
                        
                         <div class="col-md-4" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/spaciouspark.png')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Spacious<br /> Parking Area</p></li>
                            </div>
                    ...
                    @media (max-width: 425px) {
                       ...
                       <div class="row packservices">
                         <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/metro.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Near Pari Chowk<br /> Metro Station</p></li>
                            </div>
                             <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/airport.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">30 Minutes From<br /> Upcoming Jewar Airport</p></li>
                            </div>
                             <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/oc.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Occupancy Certificate<br /> (OC) Received</p></li>
                            </div>
                        <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/concierge.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Efficient Concierge<br /> Service</p></li>
                            </li>
                        </div>
                         <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/commercial.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Centrally<br /> Airconditioned</p></li>
                           </div>
                        
                        
                         <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/aircondition.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">100% Commercial<br /> Spacious, No restriction Of<br />IT/ITES Bye Laws </p></li>
                            </div>
                        
                            <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/hub.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Amidst Dense Corporate,<br /> Retail, Residential,<br /> Institutional & Industrial Hub</p></li>
                            </div>
                             <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/floorplate.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">70,000 Sq Ft Floor<br /> Plates With Sprawling<br />Efficiency</p></li>
                            </div>
                             <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/businesscenter.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Fully Equipped<br /> Business Centre</p></li>
                            </div>
                        <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/recreationclub.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Recreational<br /> Club</p></li>
                           
                          
                        </li></div>
                         <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/parking.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Dedicated Spacious<br /> Parking Space</p></li>
                           </div>
                        
                        
                         <div class="col-md-3" style="margin-top: 40px;">
                            <ul class="services-included">
                            <li><img src="<?php echo e(asset('public/images/towericons/shuttle.jpg')); ?>" style="width: 120px;"><p style="margin-top: 10px;text-align: center;">Free Metro Shuttle<br /> Service For Occupants</p></li>
                            </div>
                    ...
                    <?php if(count($inclusions) != 0): ?>
                        <?php if($pack_type=="occasional"): ?>
                            ...
                            <div class="col-2 incluions-title">
                                <img src="<?php echo e(asset('public/images/inclusionicons.jpg')); ?>">Inclusions
                            </div>
