...
<div class="panel-content">
  <form action="<?php echo e(URL::to('admin/packs/upload')); ?>" method="post">
...
$(document).ready(function()
{
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/packs/delete_featured_app/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
...
$("#fileuploader").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/packs/delete_icon/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
...
$("#fileuploader6").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/packs/delete_vidicon/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
...
$("#fileuploader5").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/packs/delete_mobile_banner/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
...
$("#fileuploader3").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/packs/delete_forground/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
...
$("#fileuploader4").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/packs/delete_featured/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
 ...
 url:"<?= URL::to('admin/packs/upload_gallery') ?>",
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/packs/delete_gallery/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
