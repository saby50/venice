            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 wow fadeInUp" data-wow-delay="0.2s" style="padding-left: 0;z-index: 500;">
                        <div class="pic1">
                            <a href="<?= URL::to('commercial') ?>"><img src="<?php echo e(asset('public/images/commercial.jpg')); ?>" class="web_banner"></a>
                           <a href="<?= URL::to('commercial') ?>"> <img src="<?php echo e(asset('public/images/commercial_mobile.jpg')); ?>" class="mobile_banner"></a>
...
<?php /**PATH C:\xampp\nxampp\htdocs\venice\resources\views/include/subfooter.blade.php ENDPATH**/ ?>