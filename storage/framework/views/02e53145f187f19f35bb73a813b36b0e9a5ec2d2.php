        ...
        <div class="hero-container">
            <div class="row" style="width: 100%;">
                ...
                <div class="col-md-4 login-form">
                    <h3 class="text-center loginhead"><span class="underline">Login</span></h3>
                    <p class="text-center mt-4">Please login to access your dashboard!</p>
                    ...
                    <form action="<?php echo e(URL::to('clogin')); ?>" method="post">
                      <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                        ...
                        <div class="form-group text-center">
                           <a href="<?php echo e(URL::to('register')); ?>" style="font-size: 14px;">Register</a><br />
                            <a href="<?php echo e(URL::to('forgot')); ?>" style="font-size: 14px;">Forgot PIN?</a>
                        </div>
