			...
			<div class="widget">
				<div class="product-filter">
					...
					<div class="row" style="min-height: 200px;">
						<form action="<?php echo e(URL::to('admin/updatemailers')); ?>" method="post">
							<?php echo csrf_field(); ?>
						<div class="col-md-4">
