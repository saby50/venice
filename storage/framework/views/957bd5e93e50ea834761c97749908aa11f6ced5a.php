...
<head>
    <meta charset="utf-8">
    <title>The Grand Venice Mall | <?php echo $__env->yieldContent('title'); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/css/jquery.timepicker.min.css')); ?>">
    <script src="<?php echo e(asset('public/js/jquery.timepicker.min.js')); ?>"></script>
    <?php 
$check_mobile = Helper::check_mobile();
if($check_mobile=="1"):?>
 <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/css/front/stylepwa.css')); ?>"> 
...
$check_mobile = Helper::check_mobile();
if($check_mobile=="1"):?>
<?php echo $__env->make('layouts.headerpwa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

 <?php echo $__env->yieldContent('content'); ?>

     <?php echo $__env->make('layouts.footerpwa', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  if ('serviceWorker' in navigator) {
   ...
   <?php endif; ?>
     ...
     <div id="landScapeError">
      <div class="row">
        <div class="col-5">
          <img src="<?php echo e(asset('public/images/LandscapeMode_bhpxby.webp')); ?>">
...
</html><?php /**PATH C:\xampp\nxampp\htdocs\venice\resources\views/layouts/main2.blade.php ENDPATH**/ ?>