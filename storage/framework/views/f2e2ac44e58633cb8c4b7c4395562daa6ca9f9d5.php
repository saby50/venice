...
<div class="panel-content">
  <form action="<?php echo e(URL::to('admin/shops/uploadr')); ?>" method="post">
...
$("#fileuploader7").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/shops/delete_home_banner/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
...
$("#fileuploader9").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/shops/delete_logo/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
...
$("#fileuploader8").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/shops/delete_home_mobile_banner/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
...
$("#fileuploader4").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/shops/delete_featured/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
...
$("#fileuploader3").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/shops/delete_banner/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
...
$("#fileuploader5").uploadFile({
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/shops/delete_mobile_banner/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
 ...
 url:"<?= URL::to('admin/shops/upload_gallery') ?>",
  ...
  deleteCallback: function (data, pd) {
    for (var i = 0; i < data.length; i++) {
        $.post("<?= URL::to('admin/shops/delete_gallery/') ?>",  {op: "delete",name: data[i], id : "<?= Request::segment(4) ?>","_token":"<?php echo e(csrf_token()); ?>"},
            function (resp,textStatus, jqXHR) {
                //Show Message
                alert("File Deleted");
            });
