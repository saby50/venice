...
Route::get('food_card/reject', 'FoodcardController@reject_success');
Route::get('food_card/recharge', 'FoodcardController@recharge');
Route::get('cancelrequest/{phone}/{order_id}/{status}', 'FoodcardController@cancelrequest');
...
Route::post('book_slot', 'EpassController@book_slot');
