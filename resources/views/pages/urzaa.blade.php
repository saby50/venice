  ...
  <?php else: ?>
    <section id="" class="homehero" style="z-index: 1;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:550px;overflow:hidden;">
            <div>
                <img data-u="image" src="{{ asset('public/images/pages/finedining.jpg') }}" class="desktop" />
                <img data-u="image" src="{{ asset('public/images/pages/finedininga.jpg') }}" class="mobile" />
            </div>
    ...
    <div id="packages" class="wow fadeInDown" style="display: none;">
        <div class="row" style="width: 100%; text-align: center; margin-left: 0; margin-right: 0; padding-top: 0.5rem; padding-bottom: 0.5rem;">
            ...
            <div class="col-4">
                <div class="pack pk2">
                    <a href="<?= URL::to('urzaa#bmenu') ?>"><img src="{{ asset('public/images/finedinea.jpg') }}"></a>
            ...
            <div class="col-4">
                <div class="pack pk3">
                    <a href="<?= URL::to('bakery#bmenu') ?>"><img src="{{ asset('public/images/bakery.jpg') }}" onmouseover="this.src='{{ asset('public/images/bakerya.jpg') }}'" onmouseout="this.src='{{ asset('public/images/bakery.jpg') }}'"></a>
      ...
      About Section
    ============================-->
        <section id="about" style="background: url({{ asset('public/images/pages/bg1.jpg') }});background-repeat: no-repeat;padding: 40px;">
            <div class="container">
                <div class="row">
                  <div class="col-md-5 col-12">
                    <?php if(Helper::check_mobile()==1): ?>
                        ...
                        <iframe width="100%" height="250" class="youtube-video" src="https://www.youtube.com/embed/O2YpPz9mFxU?start=2" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                         <?php else: ?>
                          <img src="{{ asset('public/images/pages/bohemiavid.png') }}">
    ...
    ============================-->
        <section id="about" style="display: none;">
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-12">
                        <img src="{{ asset('public/images/pages/urzaavid.png') }}">
