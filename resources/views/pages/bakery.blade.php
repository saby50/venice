...
@endsection
@section('includes')
     <meta property="og:title" content="The Grand Venice Mall | Cafe & Bakeries">
    <meta property="og:description" content="Your Favorite Delcacies Await You Here">
...
<?php if(Helper::check_mobile()==1): ?>
      <div class="slider-pwa">
        <img data-u="image" src="{{ asset('public/images/pages/bakeriesm.jpg') }}"  class="mobile" />
      </div>
  <?php else: ?>
  <!--==========================
    Hero Section
  ============================-->
    <section id="" class="homehero" style="z-index: 1;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:550px;overflow:hidden;">
            <div>
                <img data-u="image" src="{{ asset('public/images/pages/bakeries.jpg') }}" class="desktop" />
                <img data-u="image" src="{{ asset('public/images/pages/bakeriesm.jpg') }}" class="mobile" />
            </div>
...
<?php endif; ?>
    ...
    <div id="packages" class="wow fadeInDown" style="display: none;">
        <div class="row" style="width: 100%; text-align: center; margin-left: 0; margin-right: 0; padding-top: 0.5rem; padding-bottom: 0.5rem;">
            <div class="col-4">
                <div class="pack pk1">
                    <a href="<?= URL::to('terrazzo#bmenu') ?>"><img src="{{ asset('public/images/foodcourt.jpg') }}"  onmouseover="this.src='{{ asset('public/images/foodcourta.jpg') }}'" onmouseout="this.src='{{ asset('public/images/foodcourt.jpg') }}'"></a>
            ...
            <div class="col-4">
                <div class="pack pk2">
                    <a href="<?= URL::to('urzaa#bmenu') ?>"><img src="{{ asset('public/images/finedine.jpg') }}" onmouseover="this.src='{{ asset('public/images/finedinea.jpg') }}'" onmouseout="this.src='{{ asset('public/images/finedine.jpg') }}'"></a>
            ...
            <div class="col-4">
                <div class="pack pk3">
                    <a href="<?= URL::to('bakery#bmenu') ?>"><img src="{{ asset('public/images/bakerya.jpg') }}"></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-12">
                      <?php if(Helper::check_mobile()==1): ?>
                        <br /><br /><br /><br />
                        <iframe width="100%" height="250" class="youtube-video" src="https://www.youtube.com/embed/PddSUho7PeI?start=2" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                         <?php else: ?>
                           <img src="{{ asset('public/images/pages/bakeryvid.png') }}">
                    ...
                    <div class="col-md-7 col-12">
                        <div class="section-header">
                           <h2 class="section-title">Your Favorite Delicacies</h2>
                            <h3>Await You Here</h3>
                          
                       <p>When all you want to do is eat your favorite delicacies and enjoy your favorite books either alone or with a loved one; you should come and visit our cafes and bakeries.  Lip smacking food coupled with your favorite beverage will make up for a truly memorable experience.  Go ahead,  treat yourself to your favorite delicacies here.
 ...
 <section id="logoarea">
            <div class="container">
                <div class="row" style="height: 250px;">
                    ...
                    <div class="col-md-3 col-12 logosmargin">
                        <img src="{{ asset('public/images/gallery/bakery/bakery1.jpg') }}" style="width: 220px;">                       
                    </div>
                     <div class="col-md-3 col-12 logosmargin">
                        <img src="{{ asset('public/images/gallery/bakery/bakery2.jpg') }}" style="width: 220px;">                      
                    </div>
                    <div class="col-md-3 col-12 logosmargin" >
                        <img src="{{ asset('public/images/gallery/bakery/bakery3.jpg') }}" style="width: 220px;">                      
                    </div>
                     <div class="col-md-3 col-12 logosmargin">
                        <img src="{{ asset('public/images/gallery/bakery/bakery4.jpg') }}" style="width: 220px;">                      
                    </div>
  ...
  <ul class="mobile-slider2">
                <li>
                   <img src="{{ asset('public/images/gallery/bakery/gallery3.jpg') }}">
                 </li>
                    <li>
                   <img src="{{ asset('public/images/gallery/bakery/gallery2.jpg') }}">
                 </li> 
                  <li>
                   <img src="{{ asset('public/images/gallery/bakery/gallery1.jpg') }}">
                 </li> 
      ...
      $(function() {
        ...
        $(".modalclick").click(function() {
           $('#myModal').modal({backdrop: 'static', keyboard: false});
               $('.youtube-video').attr('src','https://www.youtube.com/embed/PddSUho7PeI?start=2&autoplay=1');
              
        });
        $("#myModal .close").click(function() {
           $('.youtube-video').attr('src','https://www.youtube.com/embed/PddSUho7PeI?start=2');
        });
      });
    </script>
<script type="text/javascript">
