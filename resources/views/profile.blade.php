                ...
                <div class="col-md-8 col-12 my-profile">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane container active" id="tab11">
                            <form class="mt-5 profilemar" method="post" action="{{ URL::to('profile/update') }}">
                                @csrf
                            @if (session('error'))
                           ...
                           @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone" value="{{ Auth::user()->phone }}" placeholder="Phone" readonly="readonly">
                                </div>
