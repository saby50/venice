...
<br /><br />
                   ...
                   <p>Your request for refund is successfully recorded.
                    Please collect cash from the billing counter!<br /><br />
                   ...
                   <br />
                   <?php else: ?>
                      <img src="{{ asset('public/images/oops.png') }}"><br /><br />
                   ...
                   <?php endif; ?>
                    ...
                    <?php if($status=="success"): ?>
                   <a href="{{ URL::to('/') }}"><button type="button" class="btn checkoutbtn btn-width">Go to home</button></a>
                   <?php else: ?>
                    <a href="{{ URL::to('/cart') }}"><button type="button" class="btn checkoutbtn btn-width">Retry</button></a>
                   <?php endif; ?>
