            ...
            <div class="container wow fadeInUp">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-3 col-12 social">
                        <h6>SOCIAL</h6>
                        <ul class="mt-4">
                            <li><a href="https://www.facebook.com/GrandVenice/" target="_blank"><img src="{{ asset('public/images/Social-Icon-Facebook.png') }}">&nbsp;&nbsp; Facebook</a></li>
                            <li><a href="https://twitter.com/venice_grand/" target="_blank"><img src="{{ asset('public/images/Social-Icon-Twitter.png') }}">&nbsp;&nbsp; Twitter</a></li>
                            <li><a href="https://www.instagram.com/grandvenicemall/"><img src="{{ asset('public/images/Social-Icon-Instagram.png') }}">&nbsp;&nbsp; Instagram</a></li>
                            <li><a href="https://www.youtube.com/channel/UCnigkZG9wbheaIW36_AuP3Q" target="_blank"><img src="{{ asset('public/images/Social-Icon-Youtube.png') }}">&nbsp;&nbsp; Youtube</a></li>
                    ...
                    <div class="col-md-3 col-12">
                        ...
                        <div class="TripAdvisor mt-4">
                            <img src="{{ asset('public/images/TripAdvisor.png') }}">
