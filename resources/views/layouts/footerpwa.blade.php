...
<div class="footerpwa">
	<ul class="footer-menu-pwa">
		...
		<li><a href="<?= URL::to('foodorder') ?>"><img src="{{ asset('public/images/pwa/fooda.png') }}"> <br /></a>Pay</li>
		<?php else: ?>
		<li><a href="<?= URL::to('foodorder') ?>"><img src="{{ asset('public/images/pwa/food.png') }}"> <br /></a>Pay</li>
		<?php endif; ?>
