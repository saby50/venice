...
<?php if(count($cart)==0): ?>
 ...
 <div class="recyclerview firstbox">
  ...
  <div class="row">
      ...
      ?>
    <div class="col-2" style="background: url(<?= URL::to('public/uploads/foodstore/'.$foodstore) ?>);width: 100%;height: 40px;background-position: center;background-size: contain;margin-left: 10px">
      ...
      <?php $i=0; foreach($cart as $key => $value): ?>
        ...
        ?>
                  <?php if($veg_nonveg=="veg"): ?>
                    <img src="{{ asset('public/images/veg.png') }}" style="margin-top: 0px;width: 16px;">
                    <?php else: ?>
                        <img src="{{ asset('public/images/nonveg.png') }}" style="margin-top: 0px;width: 16px;">
                  <?php endif; ?>
