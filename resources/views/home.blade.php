...
@section('content')
  <div class="sideicons desktop">
     <a href="<?= URL::to('categories/#gondolaride') ?>" data-placement="left"  data-toggle="tooltip" title="Gondola Ride"><img src="{{ asset('public/images/home/n/icongond.png') }}" onmouseover="this.src='{{ asset("public/images/home/n/icongonda.png") }}'"  onmouseout="this.src='{{ asset("public/images/home/n/icongond.png") }}'"></a>

      <br />
      <a href="<?= URL::to('categories/#mastizone') ?>" data-placement="left" data-toggle="tooltip" title="Masti Activities
"><img src="{{ asset('public/images/home/n/iconmasti.png') }}" onmouseover="this.src='{{ asset("public/images/home/n/iconmastia.png") }}'"  onmouseout="this.src='{{ asset("public/images/home/n/iconmasti.png") }}'"></a>
         <br />
...
<?php 
    ...
    <section class="wallet_area">
            ...
            <div class="col-md-12 walletbg">
              <div class="row d-flex justify-content-center">
                <div class="col-md-4">
                 ...
                 <div class="col-md-3"><br /><img src="{{ asset('public/images/wallicon.png') }}" style="height: 120px;"></div> 
        ...
        <?php endif; ?></div> 
                   ...
                   <div class="col-md-4">
                     <br />
                  <img src="{{ asset('public/images/wallbefore.png') }}" style="height: 30px;">
        ...
        <a href="{{ URL::to($wallet) }}"><img src="{{ asset('public/images/pwa/recharge.PNG') }}" style="height: 50px;margin-top: 35px;margin-left: 160px;" alt="recharge.PNG"></a>
                </div>
              </div>
    ...
    <style>
        ...
        .jssora051.jssora051ds {opacity:.3;pointer-events:none;}
         .wallet_area {
          height: 170px;
          margin-bottom: 40px;
           background: url({{ asset('public/images/walletbg.jpg')  }});
