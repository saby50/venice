			...
			<div class="widget">
				<div class="product-filter">
					...
					<div class="row" style="min-height: 200px;">
						<form action="{{ URL::to('admin/addmailers') }}" method="post">
							@csrf
						<div class="col-md-4">
...
<div class="row">
	<form method="post" action="{{ URL::to('admin/update_version') }}">
		@csrf
		<div class="col-md-12">
			<div class="widget">
				<div class="product-filter">
...
?>
<div class="row">
	<form method="post" action="{{ URL::to('admin/update_food_order') }}">
		@csrf
		<div class="col-md-12">
			<div class="widget">
				<div class="product-filter">
