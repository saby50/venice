...
<div class="panel-content" ng-app="myApp" ng-controller="myCtrl">
    ...
    <li class=""><a  href="{{ URL::to('admin/bookings/today') }}">Today's Arrival</a></li>
    <li><a  href="{{ URL::to('admin/bookings/s/todays/all') }}">All Bookings</a></li>
     <?php if(Auth::user()->user_type=="superadmin" || Auth::user()->user_type=="analyst"): ?>
    <li  class="active"><a  href="{{ URL::to('admin/events_bookings') }}">Events</a></li>
