...
<header id="header">
        <div class="container">
            <div id="logo" class="pull-left">
                <a href="{{ URL::to('/') }}"><img src="{{ asset('public/images/logo.png') }}" alt="" title="" /></img></a>
            ...
            <nav id="nav-menu-container">
                ...
                <?php endforeach; ?>
                    ...
                    <li class="menu-has-children"><a href="<?= URL::to('categories#events') ?>">Events</a>
                        <ul>
                  ...
                  <?php endif; ?>
                    ...
                    <li class="menu-has-children <?php if($segment=='food-court' || $segment=='fine-dining' || $segment=='cafe-bakeries') { echo 'menu-active'; } ?>"><a href="{{ URL::to('food-court') }}">Food</a>
                     <ul>
                      ...
                      <li><a href="<?= URL::to('food-court') ?>">Food Court
                       ...
                       <li>|</li>
                    <li><a href="{{ URL::to('shopping') }}" class="active">Shopping</a></li>
                     
                    <li>|</li>
                    <li><a href="{{ URL::to('contact') }}" class="active">Contact Us</a></li>
                    <li>|</li>
                    <?php if(Auth::check()): ?>
                        <li class="menu-has-children"><a href="{{ URL::to('profile') }}"><img src="{{ asset('public/images/Login-Profile.png') }}"> <?= Auth::user()->name ?> </a>

                        <ul>
                            
                            
                            <li><a href="{{ URL::to('profile') }}">My Profile</a></li>
                         <li><a href="{{ URL::to('wallet') }}">GV Pay (<i class="fa fa-rupee"></i><?= Crypt::decrypt(Auth::user()->wall_am) ?>)</a></li>
                         <li><a href="{{ URL::to('wallet/recharge') }}">Recharge GV Pay</a></li>
                        <?php if(Auth::user()->type=="user"): ?>
                           <li><a href="{{ URL::to('history/all') }}">Order History</a></li>
                            <?php endif; ?>
                   ...
                   <?php else: ?>
                     <li><a href="{{ URL::to('login') }}"><img src="{{ asset('public/images/Login-Profile.png') }}"> Login</a></li>
                    <?php endif; ?>
...
<?php if(Auth::check()): ?>
    ...
    <div class="dropdown-content">
       ...
       <a href="{{ URL::to('history/all') }}">Order History</a>
  ...
  <?php else: ?>
   <a href="{{ URL::to('login') }}"><img src="{{ asset('public/images/Login-Profile.png') }}"> Login</a>
   <?php endif; ?>
...
<link rel="stylesheet" type="text/css" href="{{ asset('public/css/front/menu.css') }}">
